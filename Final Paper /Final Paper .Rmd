...
```{r, echo = FALSE, fig.cap = "Radius Map", out.width= "50%"}
path <- "RadiusMap.png"
...
```{r Fig2, echo = FALSE, fig.cap = "Docker Setup", out.width= "50%"}
